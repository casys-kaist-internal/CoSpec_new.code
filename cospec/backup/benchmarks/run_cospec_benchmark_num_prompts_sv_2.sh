...
export BENCHMARK_NUM_PROMPTS=1000  # Number of prompts to process

PORT=8100

# CoSpec Feature Configuration
declare -A COSPEC_CONFIGS=(
    ["colocation_consolidated"]="export COSPEC=1; export COSPEC_DYNAMIC_COLOCATION=1; export COSPEC_SELECTIVE_VALIDATION=0"
    ["colocation_consolidated_threshold_0.1"]="export COSPEC=1; export COSPEC_DYNAMIC_COLOCATION=1; export COSPEC_SELECTIVE_VALIDATION=1; export COSPEC_SELECTIVE_VALIDATION_METHOD=threshold; export COSPEC_SELECTIVE_VALIDATION_THRESHOLD=0.1"
    ["colocation_consolidated_threshold_0.3"]="export COSPEC=1; export COSPEC_DYNAMIC_COLOCATION=1; export COSPEC_SELECTIVE_VALIDATION=1; export COSPEC_SELECTIVE_VALIDATION_METHOD=threshold; export COSPEC_SELECTIVE_VALIDATION_THRESHOLD=0.3"
    ["colocation_consolidated_threshold_0.5"]="export COSPEC=1; export COSPEC_DYNAMIC_COLOCATION=1; export COSPEC_SELECTIVE_VALIDATION=1; export COSPEC_SELECTIVE_VALIDATION_METHOD=threshold; export COSPEC_SELECTIVE_VALIDATION_THRESHOLD=0.5"
    ["colocation_consolidated_tile_0.1"]="export COSPEC=1; export COSPEC_DYNAMIC_COLOCATION=1; export COSPEC_SELECTIVE_VALIDATION=1; export COSPEC_SELECTIVE_VALIDATION_METHOD=tile; export COSPEC_SELECTIVE_VALIDATION_THRESHOLD=0.1"
    ["colocation_consolidated_tile_0.3"]="export COSPEC=1; export COSPEC_DYNAMIC_COLOCATION=1; export COSPEC_SELECTIVE_VALIDATION=1; export COSPEC_SELECTIVE_VALIDATION_METHOD=tile; export COSPEC_SELECTIVE_VALIDATION_THRESHOLD=0.3"
    ["colocation_consolidated_tile_0.5"]="export COSPEC=1; export COSPEC_DYNAMIC_COLOCATION=1; export COSPEC_SELECTIVE_VALIDATION=1; export COSPEC_SELECTIVE_VALIDATION_METHOD=tile; export COSPEC_SELECTIVE_VALIDATION_THRESHOLD=0.5"
    ["colocation_consolidated_linear_0.1"]="export COSPEC=1; export COSPEC_DYNAMIC_COLOCATION=1; export COSPEC_SELECTIVE_VALIDATION=1; export COSPEC_SELECTIVE_VALIDATION_METHOD=linear; export COSPEC_SELECTIVE_VALIDATION_THRESHOLD=0.1"
    ["colocation_consolidated_linear_0.3"]="export COSPEC=1; export COSPEC_DYNAMIC_COLOCATION=1; export COSPEC_SELECTIVE_VALIDATION=1; export COSPEC_SELECTIVE_VALIDATION_METHOD=linear; export COSPEC_SELECTIVE_VALIDATION_THRESHOLD=0.3"
    ["colocation_consolidated_linear_0.5"]="export COSPEC=1; export COSPEC_DYNAMIC_COLOCATION=1; export COSPEC_SELECTIVE_VALIDATION=1; export COSPEC_SELECTIVE_VALIDATION_METHOD=linear; export COSPEC_SELECTIVE_VALIDATION_THRESHOLD=0.5"
    ["colocation_consolidated_polynomial_0.1"]="export COSPEC=1; export COSPEC_DYNAMIC_COLOCATION=1; export COSPEC_SELECTIVE_VALIDATION=1; export COSPEC_SELECTIVE_VALIDATION_METHOD=polynomial; export COSPEC_SELECTIVE_VALIDATION_THRESHOLD=0.1"
    ["colocation_consolidated_polynomial_0.3"]="export COSPEC=1; export COSPEC_DYNAMIC_COLOCATION=1; export COSPEC_SELECTIVE_VALIDATION=1; export COSPEC_SELECTIVE_VALIDATION_METHOD=polynomial; export COSPEC_SELECTIVE_VALIDATION_THRESHOLD=0.3"
    ["colocation_consolidated_polynomial_0.5"]="export COSPEC=1; export COSPEC_DYNAMIC_COLOCATION=1; export COSPEC_SELECTIVE_VALIDATION=1; export COSPEC_SELECTIVE_VALIDATION_METHOD=polynomial; export COSPEC_SELECTIVE_VALIDATION_THRESHOLD=0.5"
)
...
RESULTS_DIR="final_opt_13b_A100_sharegpt_selective_validation"
mkdir -p $RESULTS_DIR
...
run_benchmark() {
    ...
    # Run benchmark with num_prompts-based progress
    python benchmark_serving_num_prompts.py \
        --backend vllm \
        --port $PORT \
        --model $TARGET_MODEL \
