...
declare -A COSPEC_CONFIGS=(
    ...
    ["full_cospec"]="export COSPEC=1; export COSPEC_DYNAMIC_COLOCATION=1; export COSPEC_SELECTIVE_VALIDATION=1; export COSPEC_SELECTIVE_VALIDATION_METHOD=tile"
)
...
RESULTS_DIR="final_opt_13b_A100_sharegpt"
mkdir -p $RESULTS_DIR
