...
# Read the data
df = pd.read_csv('A100_tiling_results.csv')
...
# at 128 
latency_128 = df[df['num_tokens'] == 128]['mean_latency'].values[0]
plt.plot(128, latency_128, 'o', markersize=5, color='red')
plt.annotate(f'{latency_128:.1f}ms', 
            xy=(128, latency_128),
            xytext=(-10, -12),
...
# at 128 + 8 = 136
latency_136 = df[df['num_tokens'] == 136]['mean_latency'].values[0]
slowdown = latency_136 / latency_128
plt.plot(136, latency_136, 'o', markersize=5, color='red')
plt.annotate(f'{latency_136:.1f}ms', 
            xy=(136, latency_136),
            xytext=(-15, 5),
            textcoords='offset points',
            fontsize=10,
...
# Add horizontal line
plt.plot([133, 139], [latency_128, latency_128], color='red', lw=1)
...
# Title
plt.title('Model: OPT-13B / GPU: A100', fontsize=12, fontweight='bold')
...
# Save the plot
plt.savefig('tiling_effect_A100.pdf', dpi=300, bbox_inches='tight')
