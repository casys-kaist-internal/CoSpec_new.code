...
# Read the data
df = pd.read_csv('A6000_tiling_results.csv')
...
# Title
plt.title('Model: OPT-6.7B / GPU: A6000', fontsize=12, fontweight='bold')
...
# Save the plot
plt.savefig('tiling_effect_A6000_before.pdf', dpi=300, bbox_inches='tight')
