...
fig, (ax1, ax2, ax3) = plt.subplots(1, 3, figsize=(9, 2.9))
...
ax1.set_xlabel('Number of Tokens', fontsize=16)
ax1.set_ylabel('Latency (ms)', fontsize=16)
ax1.set_title('OPT-6.7B (A6000)', fontsize=16, fontweight='bold')
...
# at 192 
latency_192 = df_a6000[df_a6000['num_tokens'] == 192]['mean_latency'].values[0]
ax1.plot(192, latency_192, 'o', markersize=5, color='red')
ax1.annotate(f'{latency_192:.1f}ms', 
            xy=(192, latency_192),
            xytext=(-10, -12),
...
# at 200
latency_200 = df_a6000[df_a6000['num_tokens'] == 200]['mean_latency'].values[0]
slowdown = latency_200 / latency_192
ax1.plot(200, latency_200, 'o', markersize=5, color='red')
ax1.annotate(f'{latency_200:.1f}ms', 
            xy=(200, latency_200),
            xytext=(-15, 5),
            textcoords='offset points',
            fontsize=10,
...
ax1.annotate('', 
            ...
            fontweight='bold')
# Add horizontal line
ax1.plot([195, 205], [latency_192, latency_192], color='red', lw=1)
ax1.annotate(f'{(slowdown)*100:.0f}%',
...
# at 384
latency_384 = df_a6000[df_a6000['num_tokens'] == 384]['mean_latency'].values[0]
ax1.plot(384, latency_384, 'o', markersize=5, color='red')
ax1.annotate(f'{latency_384:.1f}ms', 
            xy=(384, latency_384),
            xytext=(-10, -12),
            textcoords='offset points',
            fontsize=10,
...
# at 392
latency_392 = df_a6000[df_a6000['num_tokens'] == 392]['mean_latency'].values[0]
slowdown_384_392 = latency_392 / latency_384
ax1.plot(392, latency_392, 'o', markersize=5, color='red')
ax1.annotate(f'{latency_392:.1f}ms', 
            xy=(392, latency_392),
            xytext=(-17, 7),
            textcoords='offset points',
            fontsize=10,
...
ax1.annotate('', 
            ...
            arrowprops=dict(arrowstyle='->', color='red', lw=1.5))
# Add horizontal line
ax1.plot([387, 397], [latency_384, latency_384], color='red', lw=1)
ax1.annotate(f'{(slowdown_384_392)*100:.0f}%',
...
ax2.annotate(f'{(slowdown)*100:.0f}%',
...
ax2.annotate(f'{(slowdown_384_392)*100:.0f}%',
            xy=(392, (latency_384 + latency_392)/2 - 1),
            xytext=(5, 0),
            textcoords='offset points',
            fontsize=12,
...
ax2.set_xlabel('Number of Tokens', fontsize=16)
ax2.set_title('OPT-13B (A100)', fontsize=16, fontweight='bold')
...
ax3.annotate(f'{(slowdown)*100:.0f}%',
...
ax3.set_xlabel('Number of Tokens', fontsize=16)
ax3.set_title('OPT-66B (H200)', fontsize=16, fontweight='bold') 
