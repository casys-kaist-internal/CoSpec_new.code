...
declare -A COSPEC_CONFIGS=(
    ["disable_by_batch"]="export COSPEC=0; export COSPEC_DYNAMIC_COLOCATION=0; export COSPEC_SELECTIVE_VALIDATION=0"
    ...
    ["colocation_dynamic_selective"]="export COSPEC=1; export COSPEC_DYNAMIC_COLOCATION=1; export COSPEC_SELECTIVE_VALIDATION=1; export COSPEC_SELECTIVE_VALIDATION_METHOD=tile; export COSPEC_SELECTIVE_VALIDATION_THRESHOLD=0.3"
...
RESULTS_DIR="A_disable_by_batch_${TIMESTAMP}"
mkdir -p $RESULTS_DIR
