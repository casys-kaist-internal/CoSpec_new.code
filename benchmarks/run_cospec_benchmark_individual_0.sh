...
declare -A COSPEC_CONFIGS=(
    ...
    ["colocation_dynamic_selective"]="export COSPEC=1; export COSPEC_DYNAMIC_COLOCATION=1; export COSPEC_SELECTIVE_VALIDATION=1; export COSPEC_SELECTIVE_VALIDATION_THRESHOLD=0.5; export COSPEC_SELECTIVE_VALIDATION_METHOD=tile"
    ["colocation_dynamic_selective_consolidated"]="export COSPEC=1; export COSPEC_DYNAMIC_COLOCATION=1; export COSPEC_SELECTIVE_VALIDATION=1; export COSPEC_SELECTIVE_VALIDATION_THRESHOLD=0.5; export COSPEC_SELECTIVE_VALIDATION_METHOD=tile"
)
...
RESULTS_DIR="final_opt_6.7b_A6000_individual"
mkdir -p $RESULTS_DIR
