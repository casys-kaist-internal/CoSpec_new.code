...
declare -A COSPEC_CONFIGS=(
    ...
    ["colocation_consolidated_selective_tile"]="export COSPEC=1; export COSPEC_DYNAMIC_COLOCATION=1; export COSPEC_SELECTIVE_VALIDATION=1; export COSPEC_CONSOLIDATED_ATTENTION=1; export COSPEC_SELECTIVE_VALIDATION_METHOD=tile"
    ["colocation_consolidated_selective_threshold_0.1"]="export COSPEC=1; export COSPEC_DYNAMIC_COLOCATION=1; export COSPEC_SELECTIVE_VALIDATION=1; export COSPEC_CONSOLIDATED_ATTENTION=1; export COSPEC_SELECTIVE_VALIDATION_METHOD=threshold; export COSPEC_SELECTIVE_VALIDATION_THRESHOLD=0.1"
    ["colocation_consolidated_selective_threshold_0.3"]="export COSPEC=1; export COSPEC_DYNAMIC_COLOCATION=1; export COSPEC_SELECTIVE_VALIDATION=1; export COSPEC_CONSOLIDATED_ATTENTION=1; export COSPEC_SELECTIVE_VALIDATION_METHOD=threshold; export COSPEC_SELECTIVE_VALIDATION_THRESHOLD=0.3"
    ["colocation_consolidated_selective_threshold_0.5"]="export COSPEC=1; export COSPEC_DYNAMIC_COLOCATION=1; export COSPEC_SELECTIVE_VALIDATION=1; export COSPEC_CONSOLIDATED_ATTENTION=1; export COSPEC_SELECTIVE_VALIDATION_METHOD=threshold; export COSPEC_SELECTIVE_VALIDATION_THRESHOLD=0.5"
    ["colocation_consolidated_selective_linear"]="export COSPEC=1; export COSPEC_DYNAMIC_COLOCATION=1; export COSPEC_SELECTIVE_VALIDATION=1; export COSPEC_CONSOLIDATED_ATTENTION=1; export COSPEC_SELECTIVE_VALIDATION_METHOD=linear"
    ["colocation_consolidated_selective_polynomial"]="export COSPEC=1; export COSPEC_DYNAMIC_COLOCATION=1; export COSPEC_SELECTIVE_VALIDATION=1; export COSPEC_CONSOLIDATED_ATTENTION=1; export COSPEC_SELECTIVE_VALIDATION_METHOD=polynomial"
)
...
#     "colocation_consolidated_selective_tile"
#     "colocation_consolidated_selective_threshold_0.1"
#     "colocation_consolidated_selective_threshold_0.3"
#     "colocation_consolidated_selective_threshold_0.5"
#     "colocation_consolidated_selective_linear"
#     "colocation_consolidated_selective_polynomial"
# )
